...
import { CLAIMS_PORTAL_HOW_IT_WORKS } from "@/lib/constants/claims-flow";
import { QUOTE_PORTAL_SUPPORT } from "@/lib/constants/quote-portal";

export function ClaimsPortalAside() {
  return (
    <div className="space-y-4">
      <div className="overflow-hidden rounded-lg border border-gray-200/80 bg-white">
        ...
        <ol className="space-y-5 p-4 sm:p-5">
          {CLAIMS_PORTAL_HOW_IT_WORKS.map((item) => (
